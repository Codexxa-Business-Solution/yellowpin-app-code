...
/// Part Time screen (Screens 18–19): Posted Jobs | Find Jobs tabs, job cards, search, filter, FAB. Has back arrow.
class PartTimeJobsPage extends StatefulWidget {
  const PartTimeJobsPage({super.key});

  @override
  State<PartTimeJobsPage> createState() => _PartTimeJobsPageState();
}
...
class _PartTimeJobsPageState extends State<PartTimeJobsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Part Time', style: AppTextStyles.screenTitle(context).copyWith(fontSize: 20)),
        centerTitle: true,
      ),
      body: Column(
  ...
  Widget _buildPostedJobsList(BuildContext context) {
    final jobs = [
      ('Site Engineer Trainee', 'ABC Company • On Site', '(Trade Apprenticeship: NATS)', 'Pune • 35 applicants', '₹10k/Month', AppAssets.vacancyLogo1),
      ('Process Engineer', 'ABC Company', null, 'Pune • 10 applicants', '₹15k/Month', AppAssets.vacancyLogo2),
      ('Process Engineer Trainee', 'ABC Company • On Site', '(Trade Apprenticeship: NATS)', 'Pune • 35 applicants', '₹7k/Month', AppAssets.vacancyLogo3),
    ];
