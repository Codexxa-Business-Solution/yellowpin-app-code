                ...
                Expanded(
                  child: Center(
                    child: Padding(
                      ...
                      child: Image.asset(AppAssets.onboardingGraphic1, fit: BoxFit.contain),
                    ),
                  ),
                ),
                Container(
                  ...
                  child: Column(
                    children: [
                      Text(
                        ...
                        style: AppTextStyles.headingLarge(context).copyWith(fontSize: 42, fontWeight: FontWeight.w700),
                      ),
                      const SizedBox(height: AppSpacing.md),
                      Text(
                        "Make your profile to show\nwho you are and meet HR\npeople like you.",
                        textAlign: TextAlign.center,
                      ...
                      Row(
                        ...
                        children: [_dot(active: true), const SizedBox(width: 10), _dot(active: false), const SizedBox(width: 10), _dot(active: false)],
                      ),
