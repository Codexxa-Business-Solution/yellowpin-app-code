...
/// Screen 40–42: Organization Profile list. Has back arrow.
class InstituteProfileListPage extends StatefulWidget {
  const InstituteProfileListPage({super.key});

  @override
  State<InstituteProfileListPage> createState() => _InstituteProfileListPageState();
}

class _InstituteProfileListPageState extends State<InstituteProfileListPage> {
  final _searchController = TextEditingController();

  final List<(String, String, String)> _organizations = [
    ('Force Motors', 'Shraddha Garden Block-18, Nea...', AppAssets.instituteProfile),
    ('Mahindra & Mahindra Ltd', 'Shraddha Garden Block-18, Nea...', AppAssets.instituteProfile),
    ('TVS Motor', 'Shraddha Garden Block-18, Nea...', AppAssets.instituteProfile),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    final filtered = q.isEmpty
        ? _organizations
        : _organizations.where((o) => o.$1.toLowerCase().contains(q) || o.$2.toLowerCase().contains(q)).toList();
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Organization Profiles', style: AppTextStyles.screenTitle(context).copyWith(fontSize: 20)),
        centerTitle: true,
        actions: [
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, i) => _organizationCard(context, filtered[i].$1, filtered[i].$2, filtered[i].$3),
            ),
          ),
        ],
      ),
  ...
  Widget _organizationCard(BuildContext context, String name, String location, String logo) {
    return Container(
        ...
        children: [
          ClipOval(
            child: Image.asset(
              ...
              height: 48,
              fit: BoxFit.cover,
              errorBuilder: (_, __, ___) => Container(width: 48, height: 48, color: AppColors.circleLightGrey, child: const Icon(Icons.school)),
            ),
          ),
            ...
            child: GestureDetector(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Location: $location', style: AppTextStyles.bodySmall(context).copyWith(color: AppColors.textSecondary), maxLines: 1, overflow: TextOverflow.ellipsis),
                ],
              ),
            ),
          ),
